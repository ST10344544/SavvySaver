  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `users` (`id`,`username`,`password`,`fullName`,`email`,`phone`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
      ...
      public User call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new User(_tmpId,_tmpUsername,_tmpPassword,_tmpFullName,_tmpEmail,_tmpPhone);
          } else {
            _result = null;
          }
          return _result;
